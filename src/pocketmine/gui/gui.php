...
class frmMain extends \wxFrame
{
    ...
    public function onMenuServerExit()
    {
        $this->Destroy();
    }
  
    public function onMenuServerStart()
    {
    ...
    public function onMenuHelpForums()
    {
        wxLaunchDefaultBrowser("http://forums.pocketmine.net");
    }
    
    public function onMenuOptionsProp()
    {
        $this->ServerProperties->ShowModal();
    }

    public function onMenuHelpAbout()
    {
    ...
    public function onMenulbPlayers($event)
    {
...
class frmProperties extends \wxDialog
{
    ...
    public function OnCancelButtonClick($event)
    {
        $event->Skip();
    }
    
    public function OnSaveButtonClick($event)
    {
        $event->Skip();
    }
