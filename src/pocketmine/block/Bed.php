...
class Bed extends Transparent{
	...
	public function onBreak(Item $item) : bool{
		...
		if(($this->meta & 0x08) === 0x08){ //This is the Top part of bed
			...
			}elseif($blockSouth->getId() === $this->id && $blockSouth->meta !== 0x08){
				$this->getLevel()->setBlock($blockSouth, new Air(), true, true);
			}elseif($blockEast->getId() === $this->id && $blockEast->meta !== 0x08){
				$this->getLevel()->setBlock($blockEast, new Air(), true, true);
			}elseif($blockWest->getId() === $this->id && $blockWest->meta !== 0x08){
